...
<head>
	...
	<link rel="stylesheet" href="all_item_css.css" type="text/css">
	...
	<div class="container">
		...
		<div class="nav">	
				...
				<ul class="link_list_for_others" style="z-index: 1">
					...
					<li class="nav_li" style="float: left"><a class="active" href="Mhome.php"> All Items </a></li>										
			...
			<div class="middle">
				...
				<img src="../images/9.jpg" class="back_image">

				<div class="item_list_div">				

				<table width="100%" align="center" border="0" name="item_table" class="item_table">

					<tr>
						<td align="center"><h1 class="column_name"> ITEM CODE </h1></td>
						<td align="center"><h1 class="column_name"> ITEM NAME </h1></td>
					</tr>
					...
					<tr>
						<td>
							<?php
								echo'<p class="itemname" align=center>'.$row['item_code'].'</p>';
							?>
						</td>

						<td>
							<?php
								echo'<p class="itemname" align=center>'.$row['item_name'].'</p>';
							?>
						</td>
