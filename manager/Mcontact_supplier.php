...
<head>
	<title>Manager(contact supplier)</title>
	...
	<div class="container">
		...
		<div class="nav">
				...
				<ul class="link_list_for_others" style="z-index: 1">
					...
					<li class="nav_li"><a class="active" href="M_sk_contact.php"> CONTACT SUPPLIER </a></li>
...
<?php
	...
	$sql = "INSERT INTO manager_to_supplier (supplier,msg_date,msg) VALUES ('$sname','".$_POST['date']."','".$_POST['message']."')";
